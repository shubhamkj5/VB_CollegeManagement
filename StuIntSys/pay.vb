...
Public Class pay
    ...
    Private Sub pay_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'SisDataSet6.tbTermBill' table. You can move, or remove it, as needed.
        Me.TbTermBillTableAdapter.Fill(Me.SisDataSet6.tbTermBill)
    ...
    Private Sub cmdsave_Click(sender As Object, e As EventArgs) Handles cmdsave.Click
        con.Close()
        con.Open()
        Using cmd As New SqlClient.SqlCommand("Insert into tbTermBill(ID,BilliD,StudentID,Firstname,Lastname,Description,BillCost,BillDate,Sem,Status)Values('" & txtid.Text & "','" & txtbillid.Text & "','" & txtstuid.Text & "','" & txtfname.Text & "','" & txtlname.Text & "','" & txtdesc.Text & "','" & txtcost.Text & "','" & txtdate.Text & "','" & txtsem.Text & "','" & txtstatus.Text & "')", con)
    ...
    Public Sub showrecord()
        ...
        Dim cmd As SqlCommand = New SqlCommand("Select * From tbTermBill", con)
    ...
    Private Sub cmddelete_Click(sender As Object, e As EventArgs) Handles cmddelete.Click
        con = New SqlConnection("Data Source=SHUBHAMKJ5;Initial Catalog=sis;Integrated Security=True")
        con.Open()
        Dim cmd As SqlCommand = New SqlCommand("Delete FROM tbTermBill WHERE ID ='" & DataGridView1.SelectedRows(0).Cells(0).Value & "'", con)
    ...
    Private Sub cmdupdate_Click(sender As Object, e As EventArgs) Handles cmdupdate.Click
        ...
        Using cmd As New SqlClient.SqlCommand("UPDATE tbtermBill Set ID='" & txtid.Text & "',Billid='" & txtbillid.Text & "',StudentID='" & txtstuid.Text & "',Firstname='" & txtfname.Text & "',Lastname='" & txtlname.Text & "',Description='" & txtdesc.Text & "',BillCost='" & txtcost.Text & "',BillDate='" & txtdate.Text & "',Sem='" & txtsem.Text & "',Status='" & txtstatus.Text & "' where ID = '" & wop & "' ", con)
    ...
    Private Sub cmdSearchs_Click(sender As Object, e As EventArgs) Handles cmdSearchs.Click
        ...
        With cmd
            .Connection = con
            .CommandText = "Select * FROM tbTermBill WHERE Firstname like '%" & txtsearch.Text & "%'"
        End With
        da.SelectCommand = cmd
        dt.Clear()
        da.Fill(dt)
