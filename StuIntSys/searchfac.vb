...
Public Class searchfac
    ...
    Private Sub searchfac_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'fillcmbItemName()
        Try
            display_user()
    ...
    Private Sub srch()
        lvList.Items.Clear()
        Dim SqlString As String = "SELECT * FROM tbStaff where (Firstname LIKE '%" & txtsearch.Text & "%')"
    ...
    Private Sub display_user()
        ...
        rs = New SqlDataAdapter("Select * from tbStaff", con)
